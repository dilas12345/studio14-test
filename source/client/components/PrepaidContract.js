...
/**
 * Component class PrepaidContract
 */
class PrepaidContract extends Component {
	/**
	 * Constructor
	 * @param {Object} props component properties PrepaidContract
	 */
	constructor(props) {
		super(props);
	...
	/**
	 * Active card changes
	 * @param {Number} activeCardIndex active card index
	 */
	...
	render() {
		...
		return (
			<form onSubmit={event => this.onSubmitForm(event)}>
				<PrepaidLayout>
					<PrepaidTitle>Fund Wallet</PrepaidTitle>
