...
const PrepaidSuccess = ({transaction, repeatPayment}) => {
	...
	return (
		<PrepaidLayout>
			<CheckIcom />
			<SectionGroup>
				<Header>Card replenished</Header>
				<Section>
					<SectionLabel>Payment Name:</SectionLabel>
					<SectionValue>Top-up from a linked card</SectionValue>
				</Section>
				<Section>
					<SectionLabel>Card replenished with:</SectionLabel>
